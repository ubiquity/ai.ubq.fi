...
export type RemovedProviderTestAdapter = Readonly<{
  fetchResponses: (body: Record<string, unknown>, options: RemovedProviderResponsesOptions) => Promise<{ response: Response }>;
...
export const fetchRemovedProviderResponses = (body: Record<string, unknown>, options: RemovedProviderResponsesOptions): Promise<{ response: Response }> =>
...
export const removedProviderModelFromEvent = (value: Record<string, unknown>): string | null => testAdapter?.modelFromEvent(value) ?? null;
