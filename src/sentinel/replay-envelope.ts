...
import { canonicalSentinelUpstreamJson, parseSentinelUpstreamTrace, type SentinelUpstreamTrace } from "./upstream-capture.ts";
...
import { boundedErrorParam, boundedFailureKind } from "./replay-observation.ts";
