...
export type StrongRouteSelection = RouteSelection | Readonly<{ kind: "routing_unavailable" }>;
...
export const codexQuotaBlockForModel = (slot: CodexRoutingSlot, model: string | null | undefined): CodexQuotaClassBlock | null =>
