...
const inspectCodexAuthPoolBinding = (value: unknown): CodexAuthPoolBinding => {
...
const codexProbeability = (
  ...
  if (!authPool.usableTwoSlotBinding || !authPoolVersionstamp) {
...
export const derivePromptCacheScopeTargetInventory = async (
  ...
  const authPool = inspectCodexAuthPoolBinding(input.codexAuthPool);
