...
export type ApiKeyUsageProvider = "cerebras" | "chatgpt_codex" | "removed_provider" | "metered" | "voyage";
...
export const normalizeApiKeyUsageRequestV3 = (value: unknown): ApiKeyUsageRequestV3 | null => {
  ...
  if (
    ...
    !(value.provider === null || value.provider === "cerebras" || value.provider === "chatgpt_codex" ||
      value.provider === "removed_provider" || value.provider === "metered" || value.provider === "voyage") ||
