...
- For reasoning controls, use OpenAI's public string values exactly: `none`, `minimal`, `low`, `medium`, `high`,
  `xhigh`, and `max`. Do not use `null` to mean no reasoning unless the official OpenAI API documentation explicitly
