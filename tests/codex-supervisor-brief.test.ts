...
import { parseSupervisorRolloutTail, resolveSupervisorRolloutPath } from "../src/codex/supervisor-log.ts";
import type { SupervisorConnection } from "../src/codex/supervisor-transport.ts";
