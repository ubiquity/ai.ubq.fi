...
Deno.test("extractCodexModelsFromText parses slugs and reasoning levels", () => {
  const text =
    'codex_cli_rs/0.99.0 {"slug":"gpt-5.2-codex","context_window":272000,"max_context_window":1000000,"auto_compact_token_limit":null,"supported_reasoning_levels":[{"effort":null},{"effort":"low"},{"effort":"high"}]}';
  ...
  assert.deepEqual(extracted?.models[0]?.supported_reasoning_levels, ["none", "low", "high"]);
});
