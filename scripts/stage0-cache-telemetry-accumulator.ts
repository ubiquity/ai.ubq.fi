// Stage 0 telemetry accumulator, split out of scripts/stage0-cache-telemetry-gate.ts.

import { createHash } from "node:crypto";

import {
  ACTIVE_TRANSITION_REASON_KEYS,
  CacheDimensionCohortReport,
  CacheTokenSummary,
  INFERENCE_TERMINAL_OUTCOMES,
  InferenceOutcomeCohortReport,
  InferenceProvider,
  InferenceRoute,
  InferenceTerminalOutcome,
  LatencySummary,
  MAX_RETAINED_REQUEST_IDS,
  MutableCacheDimensionCohort,
  MutableCacheTokenSummary,
  MutableCohort,
  MutableInferenceOutcomeCohort,
  MutableLatencySummary,
  MutableValidReportedCacheMetrics,
  PROMPT_CACHE_MODE_VALUES,
  PromptCacheMode,
  ReleaseIdentity,
  ...
  Stage0CacheTelemetryReport,
  Stage0CohortReport,
  TerminalEvent,
  UsageTelemetryStatus,
  ValidReportedCacheMetrics,
} from "./stage0-cache-telemetry-types.ts";
import { fail, parseTerminalEvent } from "./stage0-cache-telemetry-parse.ts";
...
export { Stage0CacheTelemetryAccumulator };
